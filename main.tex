...
\group{\href{http://ligm.u-pem.fr/}{Laboratoire d'informatique Gaspard-Monge}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
